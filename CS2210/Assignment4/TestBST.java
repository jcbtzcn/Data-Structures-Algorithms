...
public class TestBST {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Test 4 failedHere");
		}
		...
		try {
			...
			if (res != null) System.out.println("Test 12 failed");
				...
				if (res == null) System.out.println("Test 12 failedhere ");
		...
		try {
			...
			if(res==null) System.out.println("here");
			...
			System.out.println("Test 16 failedhere");
		}
